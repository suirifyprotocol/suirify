    ...
    <>
      ...
      <main className="site-content">
        <section>
          ...
          <img className="pin-bottom" src={object} alt="Chararcter Logo" />
          <p className='web-content'>
            <span className='dox'>DOXXING</span><br />Doxxing in Web3 is publicly revealing a pseudonymous user’s real identity or sensitive information, undermining privacy, anonymity, and decentralization principles.
          </p>
          <p className='web-anonymity'>
            <span className='dox'>ANONYMITY</span><br />Anonymity in Web3 ensures users interact pseudonymously, protecting identities, reducing tracking, and preserving privacy within decentralized blockchain ecosystems.
          </p>
          <p className='web-centralisation'>
            <span className='dox'>CENTRALISATION</span><br />Centralisation in Web3 occurs when power, governance, or control concentrates in few entities, undermining decentralization, openness, and user sovereignty principles.
          </p>
          </div>
        </section>
      </main>
